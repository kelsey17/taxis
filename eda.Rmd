...
# adjust this when I include full data set
top_10_earners = c("CFCD208495D565EF66E7DFF9F98764DA"
                   , "F153D0336BF48F93EC3913548164DDBD"
                   , "51C1BE97280A80EBFA8DAD34E1956CF6"
                   , "AB6F028ECDB62E44BE3ACEDE4E935ED6"
                   , "C5DC32CDE1B4B5A2A0F16029B62A3A10"
                   , "2BF7915E6DC6252344DA12975B2B3E06"
                   , "3AAB94CA53FE93A64811F65690654649"
                   , "F49FD0D84449AE7F72F3BC492CD6C754"
                   , "847349F8845A667D9AC7CDEDD1C873CB"
                   , "CE625FD96D0FAFC812A6957139B354A1")
...
ggplot(taxi_indiv_tips, aes(tip_rate)) + geom_histogram(binwidth = .01)
```
...
Most cabbies are about 60% cash.  There are 2 who have mroe than 10 trips (on the 10,000 data set) and all are cash.  None have 0% cash (though 40 have <20% card).
```{r}
...
ggplot(taxi_indiv_payment) + geom_histogram(aes(CSH), binwidth = .1)
```
