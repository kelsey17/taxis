...
t.test(taxi_days_Su$revenue, mu=450292.7)
t.test(taxi_days_Th$revenue, taxi_days_F$revenue)

qqnorm(taxi_days_S$revenue)                     ### output not shown
qqline(taxi_days_S$revenue)                     ### output not shown
plot(density(taxi_days_S$revenue))              ### output not shown
shapiro.test(taxi_days_Su$revenue)
#one sample t test: compare each mean to the total mean?
