...
ggplot(taxi, aes( x = pickup_longitude, y = pickup_latitude)) + geom_point(alpha = 1/510) + 
  xlim(-74.01,-73.85) + ylim(40.7,40.85) # having trouble setting this alpha to the correct value. want to be able to pick out specific long/lat points.

ggplot(taxi, aes( x = dropoff_longitude, y = dropoff_latitude)) + geom_point(alpha = 1/100)
